...
namespace API.Data.Migrations
{
    ...
    [Migration("20230630110527_applicantChanges")]
    partial class applicantChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.ApplicantEmploymentHistory", b =>
                {
                    ...
                    b.ToTable("ApplicantEmploymentHistory");
                });
            ...
            modelBuilder.Entity("API.Entities.ApplicantEmploymentHistory", b =>
                {
                    b.HasOne("API.Entities.Identity.AppUser", "User")
                        .WithMany("ApplicantEmploymentHistory")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("API.Entities.Identity.AppUser", b =>
                {
                    ...
                    b.Navigation("ApplicantEmploymentHistory");
