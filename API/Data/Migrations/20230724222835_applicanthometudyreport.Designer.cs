...
namespace API.Data.Migrations
{
    ...
    [Migration("20230724222835_applicanthometudyreport")]
    partial class applicanthometudyreport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.ApplicantaHomeStudyReport", b =>
                {
                    ...
                    b.ToTable("ApplicantaHomeStudyReports");
                });
            ...
            modelBuilder.Entity("AssessApplicationFosterApplications", b =>
                {
                    b.Property<int>("AssessApplicationsAssessId")
                        .HasColumnType("int");

                    b.Property<int>("FosterApplicationsAppId")
                        .HasColumnType("int");

                    b.HasKey("AssessApplicationsAssessId", "FosterApplicationsAppId");

                    b.HasIndex("FosterApplicationsAppId");

                    b.ToTable("AssessApplicationFosterApplications");
                });
            ...
            modelBuilder.Entity("API.Entities.ApplicantaHomeStudyReport", b =>
                {
                    b.HasOne("API.Entities.FosterApplications", "FosterApplications")
                        .WithMany("ApplicantaHomeStudyReports")
                        .HasForeignKey("FosterApplicationsAppId");
            ...
            modelBuilder.Entity("AssessApplicationFosterApplications", b =>
                {
                    b.HasOne("API.Entities.AssessApplication", null)
                        .WithMany()
                        .HasForeignKey("AssessApplicationsAssessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.FosterApplications", null)
                        .WithMany()
                        .HasForeignKey("FosterApplicationsAppId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("API.Entities.FosterApplications", b =>
                {
                    ...
                    b.Navigation("ApplicantaHomeStudyReports");
                });
